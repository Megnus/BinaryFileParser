...
#ifdef WIN32
      void SortElements(int (_USERENTRY )(const void *, const void *));
      void SortVariables(int (_USERENTRY )(const void *, const void *));
      friend int _USERENTRY (const void *, const void *);
      friend int _USERENTRY (const void *, const void *);
#else
      /*
